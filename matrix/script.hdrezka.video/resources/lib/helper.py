...
API_URL = '{0}://{1}/'.format(ADDON.getSettingString('dom_protocol'),ADDON.getSettingString('domain').rstrip('/')) 
...
RESTRICTIONS = ['аниме','эротик','ужас']
...
def write_cache(key,data,cache_time=12):
    if data:
